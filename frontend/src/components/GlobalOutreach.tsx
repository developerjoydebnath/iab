...
const InternationalVolunteers = () => {
  const locations = [
    { city: "নিউইয়র্ক", country: "যুক্তরাষ্ট্র", flag: "🇺🇸" },
    { city: "লন্ডন", country: "যুক্তরাজ্য", flag: "🇬🇧" },
    { city: "দুবাই", country: "সংযুক্ত আরব আমিরাত", flag: "🇦🇪" },
    { city: "সিডনি", country: "অস্ট্রেলিয়া", flag: "🇦🇺" },
    { city: "টরেন্টো", country: "কানাডা", flag: "🇨🇦" },
    { city: "ঢাকা", country: "বাংলাদেশ", flag: "🇧🇩" },
    { city: "রিয়াদ", country: "সৌদি আরব", flag: "🇸🇦" },
  ];
